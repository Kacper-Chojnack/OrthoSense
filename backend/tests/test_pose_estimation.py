...
from app.ai.core.pose_estimation import Landmark, PoseEstimator, PoseResult
...
def test_pose_estimator_process(mock_exists):
    ...
    mock_vision.PoseLandmarker.create_from_options.side_effect = (
        lambda *args, **kwargs: mock_landmarker
    )
