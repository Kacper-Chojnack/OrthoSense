...
mixin _$TreatmentPlanModel {
 ...
 String get id; String get name;@JsonKey(name: 'patient_id') String get patientId;@JsonKey(name: 'therapist_id') String get therapistId;@JsonKey(name: 'protocol_id') String? get protocolId; String get notes;@JsonKey(name: 'start_date') DateTime get startDate;@JsonKey(name: 'end_date') DateTime? get endDate; PlanStatus get status;@JsonKey(name: 'frequency_per_week') int get frequencyPerWeek;@JsonKey(name: 'custom_parameters') Map<String, dynamic> get customParameters;@JsonKey(name: 'created_at') DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,patientId,therapistId,protocolId,notes,startDate,endDate,status,frequencyPerWeek,const DeepCollectionEquality().hash(customParameters),createdAt);

@override
String toString() {
  return 'TreatmentPlanModel(id: $id, name: $name, patientId: $patientId, therapistId: $therapistId, protocolId: $protocolId, notes: $notes, startDate: $startDate, endDate: $endDate, status: $status, frequencyPerWeek: $frequencyPerWeek, customParameters: $customParameters, createdAt: $createdAt)';
}
...
/// Create a copy of TreatmentPlanModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? patientId = null,Object? therapistId = null,Object? protocolId = freezed,Object? notes = null,Object? startDate = null,Object? endDate = freezed,Object? status = null,Object? frequencyPerWeek = null,Object? customParameters = null,Object? createdAt = freezed,}) {
...
switch (_that) {
case _TreatmentPlanModel() when $default != null:
return $default(_that.id,_that.name,_that.patientId,_that.therapistId,_that.protocolId,_that.notes,_that.startDate,_that.endDate,_that.status,_that.frequencyPerWeek,_that.customParameters,_that.createdAt);case _:
  return orElse();
...
class _TreatmentPlanModel implements TreatmentPlanModel {
  const _TreatmentPlanModel({required this.id, required this.name, @JsonKey(name: 'patient_id') required this.patientId, @JsonKey(name: 'therapist_id') required this.therapistId, @JsonKey(name: 'protocol_id') this.protocolId, this.notes = '', @JsonKey(name: 'start_date') required this.startDate, @JsonKey(name: 'end_date') this.endDate, this.status = PlanStatus.pending, @JsonKey(name: 'frequency_per_week') this.frequencyPerWeek = 3, @JsonKey(name: 'custom_parameters') final  Map<String, dynamic> customParameters = const {}, @JsonKey(name: 'created_at') this.createdAt}): _customParameters = customParameters;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,patientId,therapistId,protocolId,notes,startDate,endDate,status,frequencyPerWeek,const DeepCollectionEquality().hash(_customParameters),createdAt);
...
/// Create a copy of TreatmentPlanModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? patientId = null,Object? therapistId = null,Object? protocolId = freezed,Object? notes = null,Object? startDate = null,Object? endDate = freezed,Object? status = null,Object? frequencyPerWeek = null,Object? customParameters = null,Object? createdAt = freezed,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,patientId,therapistId,protocolId,notes,startDate,endDate,status,frequencyPerWeek,const DeepCollectionEquality().hash(customParameters),createdAt,patientName,protocolName,sessionsCompleted,complianceRate);

@override
String toString() {
  return 'TreatmentPlanDetails(id: $id, name: $name, patientId: $patientId, therapistId: $therapistId, protocolId: $protocolId, notes: $notes, startDate: $startDate, endDate: $endDate, status: $status, frequencyPerWeek: $frequencyPerWeek, customParameters: $customParameters, createdAt: $createdAt, patientName: $patientName, protocolName: $protocolName, sessionsCompleted: $sessionsCompleted, complianceRate: $complianceRate)';
}
...
switch (_that) {
case _TreatmentPlanDetails() when $default != null:
return $default(_that.id,_that.name,_that.patientId,_that.therapistId,_that.protocolId,_that.notes,_that.startDate,_that.endDate,_that.status,_that.frequencyPerWeek,_that.customParameters,_that.createdAt,_that.patientName,_that.protocolName,_that.sessionsCompleted,_that.complianceRate);case _:
  return orElse();
...
class _TreatmentPlanDetails implements TreatmentPlanDetails {
  const _TreatmentPlanDetails({required this.id, required this.name, @JsonKey(name: 'patient_id') required this.patientId, @JsonKey(name: 'therapist_id') required this.therapistId, @JsonKey(name: 'protocol_id') this.protocolId, this.notes = '', @JsonKey(name: 'start_date') required this.startDate, @JsonKey(name: 'end_date') this.endDate, this.status = PlanStatus.pending, @JsonKey(name: 'frequency_per_week') this.frequencyPerWeek = 3, @JsonKey(name: 'custom_parameters') final  Map<String, dynamic> customParameters = const {}, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'patient_name') this.patientName = '', @JsonKey(name: 'protocol_name') this.protocolName, @JsonKey(name: 'sessions_completed') this.sessionsCompleted = 0, @JsonKey(name: 'compliance_rate') this.complianceRate = 0.0}): _customParameters = customParameters;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,patientId,therapistId,protocolId,notes,startDate,endDate,status,frequencyPerWeek,const DeepCollectionEquality().hash(_customParameters),createdAt,patientName,protocolName,sessionsCompleted,complianceRate);
