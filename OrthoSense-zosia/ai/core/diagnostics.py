...
class MovementDiagnostician:
    ...
    def diagnose(self, exercise_name, skeleton_data):
        ...
        # if exercise_name == "Inline Lunge":
        #     errors = []
        #     for frame in skeleton_data:
        #         shoulder_mid = (self._get_coords(frame, 'LEFT_SHOULDER') + self._get_coords(frame, 'RIGHT_SHOULDER')) / 2
        #         hip_mid = (self._get_coords(frame, 'LEFT_HIP') + self._get_coords(frame, 'RIGHT_HIP')) / 2
        #         if abs(shoulder_mid[0] - hip_mid[0]) > 0.15:
        #             errors.append("Torso is not vertical.")
        #     if not errors:
        #         return True, "Movement correct."
        #     return False, f"ERRORS: {', '.join(set(errors))}"
        
        # if exercise_name == "Side Lunge":
        #     errors = []
        #     for frame in skeleton_data:
        #         ang_l = self.calculate_angle(
        #             self._get_coords(frame, 'LEFT_HIP'),
        #             self._get_coords(frame, 'LEFT_KNEE'),
        #             self._get_coords(frame, 'LEFT_ANKLE'))
        #         ang_r = self.calculate_angle(
        #             self._get_coords(frame, 'RIGHT_HIP'),
        #             self._get_coords(frame, 'RIGHT_KNEE'),
        #             self._get_coords(frame, 'RIGHT_ANKLE'))
        ...
        # if exercise_name == "Sit to Stand":
        #     errors = []
        #     for frame in skeleton_data:
        #         dist_l = self.calculate_distance(
        #             self._get_coords(frame, 'LEFT_WRIST'),
        #             self._get_coords(frame, 'LEFT_KNEE'))
        #         dist_r = self.calculate_distance(
        #             self._get_coords(frame, 'RIGHT_WRIST'),
        #             self._get_coords(frame, 'RIGHT_KNEE'))
        ...
        # if exercise_name == "Standing Active Extension":
        #     errors = []
        #     for frame in skeleton_data:
        ...
        #             self._get_coords(frame, 'RIGHT_KNEE'),
        #             self._get_coords(frame, 'RIGHT_ANKLE'))
        #         if knee_l < 160 or knee_r < 160:
        #             errors.append("Keep knees straight during extension.")
        #     if not errors:
        #         return True, "Movement correct."
        #     return False, f"ERRORS: {', '.join(set(errors))}"
        
        # if exercise_name == "Standing Active Flexion":
        #     errors = []
        #     for frame in skeleton_data:
        #         knee_l = self.calculate_angle(
        #             self._get_coords(frame, 'LEFT_HIP'),
        ...
        #             self._get_coords(frame, 'RIGHT_KNEE'),
        #             self._get_coords(frame, 'RIGHT_ANKLE'))
        #         if knee_l < 150 or knee_r < 150:
        #             errors.append("Do not bend knees.")
        #     if not errors:
        #         return True, "Movement correct."
        #     return False, f"ERRORS: {', '.join(set(errors))}"
        
        # if exercise_name == "Standing Rotation":
        #     errors = []
        #     for frame in skeleton_data:
        #         hip_l = self._get_coords(frame, 'LEFT_HIP')
        #         hip_r = self._get_coords(frame, 'RIGHT_HIP')
        #         if abs(hip_l[2] - hip_r[2]) > 0.15:
        #             errors.append("Keep hips facing forward, isolate torso.")
        #     if not errors:
        #         return True, "Movement correct."
        #     return False, f"ERRORS: {', '.join(set(errors))}"
        ...
        #         shoulder_mid = (self._get_coords(frame, 'LEFT_SHOULDER') + self._get_coords(frame, 'RIGHT_SHOULDER')) / 2
        #         hip_mid = (self._get_coords(frame, 'LEFT_HIP') + self._get_coords(frame, 'RIGHT_HIP')) / 2
        #         lean_forward_back = abs(shoulder_mid[2] - hip_mid[2])
        #         lean_side = abs(shoulder_mid[0] - hip_mid[0])
        #         if lean_forward_back > 0.20 or lean_side > 0.15:
        #             errors.append("Maintain upright posture while walking.")
        #     if not errors:
        #         return True, "Movement correct."
        #     return False, f"ERRORS: {', '.join(set(errors))}"
